...
const Agence = () => {
  ...
  return (
    <div className='parent'>
      ...
      <div id="page2" className='h-screen w-full bg-black overflow-hidden flex justify-center items-center'>
        <div className='relative flex flex-col items-center'>
          <h1 className='text-white text-7xl font-[font2] -mt-1 pb-3'>Our CEO</h1>
          <img className='h-[450px] w-auto rounded-xl mt-5' src="https://k72.ca/uploads/teamMembers/HugoJoseph_480x640-480x640.jpg"/>
          <div className='absolute bottom-6 left-1/2 -translate-x-1/2 w-full flex justify-center'>
            <h2 className='text-[#D3FD50] text-[4vw] font-[font2] bg-black/30 px-6 py-2 rounded-lg'>Hugo Joseph</h2>
          </div>
        </div>
      </div>
    </div>
