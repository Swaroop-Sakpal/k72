    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div onClick={()=>{
                ...
                className='h-12 bg-black relative w-45'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full px-7 flex flex-col justify-center items-end gap-[4px]'>
                    <div className="w-12 h-[1.3px] bg-white"></div>
                    <div className="w-6 h-[1.3px] bg-white"></div>
                </div>
            </div>
        </div>
    )
